...
**Version incluse :** 5.5.26~ynh1 *(:warning: Il s'agit de la branche `ci-auto-update-v5.5.26`. La [branche `master`](https://github.com/YunoHost-Apps/invoiceninja5_ynh/tree/master) utilisée dans le catalogue est actuellement en 5.5.24\~ynh1.)*
