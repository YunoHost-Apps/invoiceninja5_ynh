...
**Shipped version:** 5.5.26~ynh1 *(:warning: This is the `ci-auto-update-v5.5.26` branch. The [`master` branch](https://github.com/YunoHost-Apps/invoiceninja5_ynh/tree/master) used in the catalog is currently on version 5.5.24\~ynh1.)*
